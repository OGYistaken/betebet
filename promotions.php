...
<!-- Mirrored from betebet486.com/promotions by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Jul 2022 10:09:37 GMT -->
...
<body style="padding-top: 0px;" class="page-main">
    ...
    document.body.classList.add('page-static-content')
    document.body.classList.add('page-promotions')
...
<main>
    ...
    <static-content>
        <div extroutelink="">
            <script>
                console.log("==== Promotion Page ====");
            </script>
            <script>
                console.log("==== Load Modal Css ====");
            </script>
            <link rel="stylesheet" href="assets/css/promotions.css">
            <div id="header-promotions">Promosyonlar</div>
            <ul class="promotions-container">
                <li id="promo-24"><a href="javascript:;" data-id="24"><img src="assets/static/img/promo/BB_ozmopa-promo-13-06-20.png"></a></li>
                <li id="promo-19"><a href="javascript:;" data-id="19"><img src="assets/static/img/promo/BB-Payfix-Promo.png"></a></li>
                <li id="promo-18"><a href="javascript:;" data-id="18"><img src="assets/static/img/promo/BB-SkyDirectApp-Promo.png"></a></li>
                <li id="promo-8"><a href="javascript:;" data-id="8"><img src="assets/static/img/promo/BB_10_Cevrimsiz_Bon_s_Promo.png"></a></li>
                <li id="promo-1"><a href="javascript:;" data-id="1"><img src="assets/static/img/promo/BB-15CmtBonus-Promo.png"></a></li>
                <li id="promo-4"><a href="javascript:;" data-id="4"><img src="assets/static/img/promo/BB_15_Deneme_Bonusu_Promo.png"></a></li>
                <li id="promo-3"><a href="javascript:;" data-id="3"><img src="assets/static/img/promo/bb-15-hizli-qr-promo.png"></a></li>
                <li id="promo-5"><a href="javascript:;" data-id="5"><img src="assets/static/img/promo/BB_100_Hosgeldin_Bonusu_Promo_2.png"></a></li>
                <li id="promo-6"><a href="javascript:;" data-id="6"><img src="assets/static/img/promo/spor-20-bonus-promo.png"></a></li>
                <li id="promo-7"><a href="javascript:;" data-id="7"><img src="assets/static/img/promo/BB_Paytopays_Paygiga_Aninda_Havale_maksi_Promo.png"></a></li>
                <li id="promo-9"><a href="javascript:;" data-id="9"><img src="assets/static/img/promo/kredi-kartina-10-cevrimsiz-promo.png"></a></li>
                <li id="promo-11"><a href="javascript:;" data-id="11"><img src="assets/static/img/promo/sanal-kartlar-yuzde10-2018-promo.png"></a></li>
                <li id="promo-12"><a href="javascript:;" data-id="12"><img src="assets/static/img/promo/cevrimsiz_yuzde_15_cepbank_2019_promo.png"></a></li>
                <li id="promo-14"><a href="javascript:;" data-id="14"><img src="assets/static/img/promo/Box2.png"></a></li>
                <li id="promo-15"><a href="javascript:;" data-id="15"><img src="assets/static/img/promo/yatirim_yap_freespin_kap_2019_a_promo.png"></a></li>
            </ul>
            <script>
                console.log("==== Add Custom Script ====");
            </script>
            <script src="assets/static/js/betebet.promotions.js"></script>
            <div class="betebet_modal_container">
                <div class="modal_image"></div>
                <div class="aciklama"></div>
            </div>
        </div>
        <div>
            <script type="text/javascript" src="assets/static/js/betebet.promotions.js"></script>
...
<!-- Mirrored from betebet486.com/promotions by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Jul 2022 10:09:41 GMT -->
</html>