...
<!-- Mirrored from betebet486.com/bingo by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Jul 2022 10:08:22 GMT -->
                ...
                <div class="casino-detail-cntr">
                    ...
                    <div class="gm-bx-l">
                        <div class="title flex-container">
                            ...
                            <div class="gm-acn"><a class="btn popup" href="tr/dashboard/payments/deposit-money.html"><i class="material-icons pg-icons">account_balance</i></a><a class="btn refresh " href="tr/dashboard/payments/transfer.html"><i class="fa fa-exchange pg-icons"></i></a><a class="btn refresh" href="javascript:;"><i class="fa fa-refresh pg-icons"></i></a><a class="btn fvrt-lnk" href="javascript:;"><i class="material-icons pg-icons">star_border</i></a><a class="btn close" href="tr/games/livecasino.html"><i class="material-icons pg-icons">close</i></a></div>
                        </div>
                        <!---->
                        <!---->
                        <!---->
                        <div class="gm-bx ng-star-inserted">
                            <div id="lgf-container" style="display: inline-block; width: 100%; height: 1000px;"><iframe name="lgf-container" id="lgf-container-iframe" width="100%" height="100%" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" scrolling="no" src="https://lobby.lgio.net/?sign=M&amp;origin=http://188betebet.com"></iframe></div>
                        </div>
                    </div>
                </div>
